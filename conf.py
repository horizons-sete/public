...
BLOG_TITLE = "Horizons Sète"
# ! Option (a) is used when you don't want that setting translated.
# ! Option (b) is used for settings that are different in different languages.


# Data about this site
BLOG_AUTHOR = "Stéphane Manet" 
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
# SITE_URL = "http://localhost:8000/"
SITE_URL = "https://horizons-sete.github.io/public/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "stephane.manet@pm.me"
BLOG_DESCRIPTION = """
Comité local Horizons à Sète, le parti d'Édouard Philippe. <br />Découvrez nos actions et engagements locaux.
"""
...
THEME_CONFIG = {
    "fr": {
        "social_links": [
            {
                "name": "Instagram",
                "url": "https://www.instagram.com/horizons_sete/",
                "icon": "instagram",
            },
            {
                "name": "Facebook",
                "url": "https://www.facebook.com/horizons.sete",
                "icon": "facebook",
            },
        ],
    },
...
# rendered
def add_pages_to_context(context, template_name):
    # Use the bound _link method to access the Nikola site instance.
    link = context.get('_link')
    site = getattr(link, '__self__', None)
    if site is None:
        return
    lang = context.get('lang')
    pages = [page for page in site.pages
             if lang is None or page.is_translation_available(lang)]
    pages.sort(key=lambda page: page.source_path)
    context['pages'] = pages

GLOBAL_CONTEXT_FILLER = [add_pages_to_context]
